...
public class TipController {
    ...
    @PutMapping("/{id}/add-subjects")
    private ResponseEntity<Tip> addSubjects(@PathVariable Long id, @RequestBody @Valid List<SubjectDTO> subjects) {
        Tip tip = service.addSubjects(id, subjects);
